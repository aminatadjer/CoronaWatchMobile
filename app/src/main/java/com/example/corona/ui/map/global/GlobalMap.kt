package com.example.corona.ui.map.global
...
import com.example.corona.ui.map.*
...
class GlobalMap : Fragment(), OnMapReadyCallback {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        for(i in 0..185){
            ...
            val gson =  Gson();
            val responseModel = gson.fromJson(jsonParser.parse(iid),
                Country::class.java)
        ...
        mapView=activity!!.findViewById(R.id.map_global) as MapView
    ...
    override fun onMapReady(googleMap: GoogleMap?) {
        ...
        Thread{
            activity!!.runOnUiThread {
                mapViewModel.setGlobalMap(googleMap!!,context!!,activity!!)
            }
        }.start()
